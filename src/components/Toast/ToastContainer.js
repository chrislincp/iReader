      ...
      <Mask mask={props.mask} maskColor={props.maskColor} maskOpacity={props.maskOpacity}>
        ...
        >
          ...
          >
            ...
            >
              {
                props.image ? <Image style={[styles.iconStyle, !props.showText && { marginBottom: 0,  backgroundColor: 'transparent' }, props.imageStyle]} source={props.image} /> :
                  props.showSuccess ? <Image style={[styles.iconStyle, !props.showText && { marginBottom: 0 }, props.imageStyle]} source={require('./image/success.png')} /> :
                    props.showFail ? <Image style={[styles.iconStyle, !props.showText && { marginBottom: 0 }, props.imageStyle]} source={require('./image/error.png')} /> :
                      props.showLoading ? <View style={[props.showText ? { paddingVertical: 10 } : { marginBottom: 0 }]}><Indicator size="large" color="#fff" /></View> : null
              }
              {
  ...
  render() {
    ...
    return props.mask ?
      <View style={styles.maskStyle}>
        <View style={[styles.maskStyle, props.maskColor && { backgroundColor: props.maskColor }, props.maskOpacity && { opacity: props.maskOpacity }]} />
        {this.props.children}
      </View> :
      this.props.children;
  }
